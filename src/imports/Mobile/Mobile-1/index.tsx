import svgPaths from "./svg-uls5h6iw1j";
...
export default function Mobile() {
  return (
    <div className="bg-white relative size-full" data-name="Mobile">
      <div className="-translate-y-1/2 absolute aspect-[679.860824192594/983.9515976357807] flex items-center justify-center left-[-138.85px] right-[-139.01px] top-[calc(50%+29.03px)]" style={{ containerType: "size" }}>
